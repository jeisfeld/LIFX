 ...
 */
public class ManageDevicesItemMoveCallback extends ItemTouchHelper.Callback {
	/**
	 * The adapter.
	 */
	 ...
	 */
	public ManageDevicesItemMoveCallback(final ItemTouchHelperContract adapter) {
		mAdapter = adapter;
	}
	...
	public final void onSelectedChanged(final RecyclerView.ViewHolder viewHolder, final int actionState) {
		if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
			if (viewHolder instanceof ManageDevicesViewAdapter.MyViewHolder) {
				ManageDevicesViewAdapter.MyViewHolder myViewHolder = (ManageDevicesViewAdapter.MyViewHolder) viewHolder;
	...
	public interface ItemTouchHelperContract {
		 ...
		 */
		void onRowSelected(ManageDevicesViewAdapter.MyViewHolder myViewHolder);
		 ...
		 * @param myViewHolder The holder of the selected view.
		 */
		void onRowClear(ManageDevicesViewAdapter.MyViewHolder myViewHolder);
	}
